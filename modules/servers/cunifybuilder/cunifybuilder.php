 ...
 * example file, the filename is "cunifybuilder" and therefore all
 * functions begin "cunifybuilder_".
 *
 ...
 * @return array
 */
function cunifybuilder_MetaData() {
    return array(
        'DisplayName' => 'Cunify Website Builder',
 ...
 * @return array
 */
function cunifybuilder_ConfigOptions() {
    return array(
 ...
 */
function cunifybuilder_CreateAccount(array $params) {
    try {
        ...
        logModuleCall(
                'cunifybuilder', __FUNCTION__, $params, $e->getMessage(), $e->getTraceAsString()
        );
 ...
 * @return string "success" or an error message
 */
function cunifybuilder_SuspendAccount(array $params) {
    try {
 ...
 * @return string "success" or an error message
 */
function cunifybuilder_UnsuspendAccount(array $params) {
    try {
 ...
 * @return string "success" or an error message
 */
function cunifybuilder_TerminateAccount(array $params) {
    try {
 ...
 * @return string "success" or an error message
 */
function cunifybuilder_ChangePassword(array $params) {
    try {
 ...
 * @return string "success" or an error message
 */
function cunifybuilder_ChangePackage(array $params) {
    try {
        // Call the service's change password function, using the values
        // provided by WHMCS in `$params`.
        //
 ...
 * @return array
 */
function cunifybuilder_TestConnection(array $params) {
    try {
 ...
 *
 * @see cunifybuilder_buttonOneFunction()
 *
 * @return array
 */
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see cunifybuilder_AdminCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function cunifybuilder_buttonOneFunction(array $params) {
    try {
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see cunifybuilder_ClientAreaCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function cunifybuilder_actionOneFunction(array $params) {
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
    } catch (Exception $e) {
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see cunifybuilder_AdminServicesTabFieldsSave()
 *
 * @return array
 */
function cunifybuilder_AdminServicesTabFields(array $params) {
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
        $response = array();
        ...
        return array(
            ...
            'Something Editable' => '<input type="hidden" name="cunifybuilder_original_uniquefieldname" '
            . 'value="' . htmlspecialchars($response['textvalue']) . '" />'
            . '<input type="text" name="cunifybuilder_uniquefieldname"'
            . 'value="' . htmlspecialchars($response['textvalue']) . '" />',
        );
    } catch (Exception $e) {
        // Record the error in WHMCS's module log.
 ...
 *
 * @see https://developers.whmcs.com/provisioning-modules/module-parameters/
 * @see cunifybuilder_AdminServicesTabFields()
 */
function cunifybuilder_AdminServicesTabFieldsSave(array $params) {
    // Fetch form submission variables.
    $originalFieldValue = isset($_REQUEST['cunifybuilder_original_uniquefieldname']) ? $_REQUEST['cunifybuilder_original_uniquefieldname'] : '';

    $newFieldValue = isset($_REQUEST['cunifybuilder_uniquefieldname']) ? $_REQUEST['cunifybuilder_uniquefieldname'] : '';
 ...
 * @return array
 */
function cunifybuilder_ServiceSingleSignOn(array $params) {
    try {
 ...
 * @return array
 */
function cunifybuilder_AdminSingleSignOn(array $params) {
    try {
 ...
 * @return array
 */
function cunifybuilder_ClientArea(array $params) {
