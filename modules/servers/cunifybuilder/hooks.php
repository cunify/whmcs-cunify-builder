 ...
 */
function hook_cunifybuilder_clientedit(array $params)
{
    try {
 ...
 */
add_hook('ClientEdit', 1, 'hook_cunifybuilder_clientedit');
    ...
    if (!is_null($menu->getChild('Services'))) {
        ...
        $menu->getChild('Services')
            ->addChild(
                ...
                array(
                    'uri' => 'clientarea.php?action=services&module=cunifybuilder',
                    'order' => 15,
                )
            );
    }
